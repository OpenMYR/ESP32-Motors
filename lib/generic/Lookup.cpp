...
const char *wifiStateEventToString(uint8_t event) {
    switch (static_cast<WifiController::myr_wifi_event_t>(event)) {
    case WifiController::MYR_WIFI_EVENT_CONN_NEW_STA:
        return "CONN_NEW_STA";
    case WifiController::MYR_WIFI_EVENT_DISCONNECT:
        return "DISCONNECT";
    case WifiController::MYR_WIFI_EVENT_CONNECTED:
        return "CONNECTED";
    case WifiController::MYR_WIFI_EVENT_CONNECTION_FAILED:
        return "CONNECTION_FAILED";
    case WifiController::MYR_WIFI_EVENT_TIMER:
        return "TIMER";
    }
...
const char *wifiStateToString(uint8_t state) {
    switch (static_cast<WifiController::myr_wifi_state_t>(state)) {
    case WifiController::MYR_WIFI_STATE_AP:
        return "AP";
    case WifiController::MYR_WIFI_STATE_STA:
        return "STA";
    case WifiController::MYR_WIFI_STATE_STA_CONNECTING:
        return "STA_CONNECTING";
    case WifiController::MYR_WIFI_STATE_AP_STA_CONNECTING:
        return "AP_STA_CONNECTING";
    case WifiController::MYR_WIFI_STATE_AP_STA_RAMPDOWN:
        return "AP_STA_RAMPDOWN";
    }
