...
public:
    ...
    typedef enum {
        MYR_WIFI_EVENT_CONN_NEW_STA = 0,
        MYR_WIFI_EVENT_DISCONNECT = 1,
        MYR_WIFI_EVENT_CONNECTED = 2,
        MYR_WIFI_EVENT_CONNECTION_FAILED = 3,
        MYR_WIFI_EVENT_TIMER = 4
    } myr_wifi_event_t;

    // State definitions
    typedef enum {
        MYR_WIFI_STATE_AP = 0,
        MYR_WIFI_STATE_STA = 1,
        MYR_WIFI_STATE_STA_CONNECTING = 2,
