...
void clear_wifi_nvs() {
    ...
    TEST_ASSERT_EQUAL(
        ESP_OK,
        nvs_set_u8(nvsHandle, WifiController::MYR_WIFI_PREF_TAG_MODE, MYR_WIFI_MODE_STATION));
...
void test_wifi_sta_mode_sequence(void) {
...
extern "C" void app_main(void) {
    UNITY_BEGIN();
    RUN_TEST(test_wifi_sta_mode_sequence);
    UNITY_END();
}
