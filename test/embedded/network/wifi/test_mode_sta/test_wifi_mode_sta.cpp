...
void test_wifi_default_to_sta(void){
    ...
    TEST_ASSERT_EQUAL(WifiController::MYR_WIFI_STATE_STA_CONNECTING, WifiController::getWiFiState()); // this occurs as MYR_WIFI_STATE_STA or  MYR_WIFI_STATE_STA_CONNECTING
}
...
void test_wifi_sta_to_sta(void){
    ...
    TEST_ASSERT_EQUAL(WifiController::MYR_WIFI_STATE_STA_CONNECTING, WifiController::getWiFiState()); // can this be MYR_WIFI_STATE_STA_CONNECTING or MYR_WIFI_STATE_AP_STA_CONNECTING
}
