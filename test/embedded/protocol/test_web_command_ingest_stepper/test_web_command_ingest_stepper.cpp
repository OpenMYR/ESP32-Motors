...
void test_motion_command_accepts_zero_rate_for_immediate_stepper_reposition(void)
{
...
extern "C" void app_main(void)
{
    ...
    RUN_TEST(test_motion_command_accepts_zero_rate_for_immediate_stepper_reposition);
